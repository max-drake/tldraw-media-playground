  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "pattern",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x: "0", y: "0", width: "8", height: "8", fill: colors.solid, mask: `url(#${maskId})` })
      }
    )
  ] });
}
...
const generateImage = (dpr, currentZoom, solid) => {
  return new Promise((resolve, reject) => {
    const size = TILE_PATTERN_SIZE * currentZoom * dpr;
    const canvasEl = (0, import_editor.getGlobalDocument)().createElement("canvas");
    canvasEl.width = size;
...
function usePattern() {
  ...
  const maxEffectiveZoom = (0, import_editor.useValue)(
    "maxEffectiveZoom",
    () => {
      const steps = editor.getCameraOptions().zoomSteps;
      return (0, import_editor.last)(steps) / steps[0];
    },
    [editor]
  );
